    ...
    return (
        <section className="slide-section">
            <div className="slide-container">
                ...
                <h1 className="hero-title" style={{ fontSize: '32px', marginBottom: '50px' }}>학교폭력 사안 5년간 2.3배 급증,<br />법적 분쟁 시장은 구조적 성장 국면 진입</h1>
                    </div>
                ...
                {/* Bottom Section */}
                <div>
                    <h2 style={{ fontSize: '19px', fontWeight: 700, marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '14px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '20px' }}>
                        ...
                        <PolicyCard
                            ...
                            description={
                                <div>
                                    <p>1~3호 초범: 생기부 기재 유보 가능 <strong style={{ color: 'var(--apple-red)' }}>→ 4호 이상 즉시 기재</strong></p>
                ...
                {/* Custom Insight Banner for Market Overview */}
                <div className="insight-banner" style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                        <p style={{ fontSize: '18px', fontWeight: 600, color: '#856404', margin: '0 0 4px 0' }}>
                            <span style={{ fontWeight: 700 }}>시사점:</span> 학폭은 '학교 내 문제'가 아니라 '법적 분쟁 시장'으로 전환 중
                        </p>
                        <ol style={{ fontSize: '16px', fontWeight: 500, color: '#997b2d', lineHeight: '1.6', margin: '0 0 0 20px', padding: 0 }}>
                            <li><span style={{ color: '#856404', fontWeight: 600 }}>가해학생 행정소송 증가</span> → 처분 이후 법적 대응 단계 확장</li>
                            <li><span style={{ color: '#856404', fontWeight: 600 }}>초등학생 비율 최다</span> → 조기 개입 필요성 확대</li>
                            <li><span style={{ color: '#856404', fontWeight: 600 }}>언어폭력 최다 유형</span> → 증거화·기록화 서비스 수요 증가</li>
                        </ol>
                    </div>
                </div>
                    </div>
