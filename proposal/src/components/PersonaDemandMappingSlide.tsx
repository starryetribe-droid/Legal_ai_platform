        ...
        <section className="slide-section">
            <div className="slide-container">
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    {/* Top Badge - Subdued Style */}
                    <div style={{
                        backgroundColor: 'transparent',
                        color: 'var(--apple-secondary-text)',
                        border: '1px solid var(--apple-secondary-text)',
                        padding: '4px 12px',
                        borderRadius: '20px',
                        fontSize: '14px',
                        fontWeight: 600,
                    ...
                    <div style={{ marginBottom: '32px' }}>
                        <h1 className="hero-title" style={{ fontSize: '28px', marginBottom: '8px', color: '#1d1d1f' }}>페르소나별 핵심 수요 상세 매핑</h1>
                        <p style={{ fontSize: '18px', color: 'var(--apple-secondary-text)', lineHeight: '1.5' }}>
