        ...
        <section className="slide-section" style={{ height: 'auto', minHeight: '100vh', padding: '60px 0', overflow: 'visible' }}>
            <div className="slide-container" style={{ height: 'auto', display: 'block', overflow: 'visible', maxWidth: '1400px' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '50px' }}>
                    ...
                    <h1 style={{ fontSize: '38px', fontWeight: 800, marginBottom: '12px', color: '#1d1d1f' }}>
                ...
                <div style={{ display: 'flex', gap: '50px', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        <ColumnHeader title="피해자 케이스" color="#f5f5f7" textColor="#1d1d1f" borderColor="#c7c7cc" />
                        ...
                        <div style={{ background: '#f5f5f7', padding: '20px', borderRadius: '16px', border: '1px solid #e5e5e7', marginTop: '10px' }}>
                            <p style={{ fontSize: '14px', color: '#8e8e93', marginBottom: '16px' }}>무료 구간 — 혼자서도 할 수 있는 것</p>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginTop: '10px' }}>
                            <FlowBox title="부모님께 결과 공유" content={["미성년자는 결제할 수 없기에", "부모에게 상황을 공유해야함"]} color="#e8f5e9" borderColor="#34c759" />
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0 40px', marginTop: '4px', marginBottom: '8px' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        <ColumnHeader title="가해자 케이스" color="#f5f5f7" textColor="#1d1d1f" borderColor="#c7c7cc" />
                        ...
                        <SectionLabel label="② 접속 계기" />
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                            <FlowBox title="경로 B" content={["학폭 진단 테스트 유입"]} color="#fff3e0" borderColor="#ffcc00" />
                            <FlowBox title="경로 A" content={["학폭위 회부 통보 연락 후 검색"]} color="#fff3e0" borderColor="#ffcc00" />
                        </div>
                        ...
                        <div style={{ background: '#f5f5f7', padding: '20px', borderRadius: '16px', border: '1px solid #e5e5e7', marginTop: '10px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px' }}>
                                ...
                                <FlowBox title="유사 사례 판례 조회" content={["비슷한 사례 처분 범위", "학폭위 타임라인 안내"]} color="#fff3e0" borderColor="#ffcc00" />
